...
const actsEvents = [
  ...
  { name: '1차 전도여행', start: 46.0, end: 48.0, type: 'journey', route: '안디옥, 구브로, 비시디아 안디옥, 이고니온, 루스드라, 더베', event: '바울과 바나바가 구브로와 남갈라디아 지역을 순회한다.', row: 0 },
  { name: '예루살렘 공의회', year: 49.0, type: 'acts', refs: '행 15장, 갈 2장', event: '이방 신자에게 율법 멍에를 지우지 않기로 결정한다.', row: 1, major: true },
  { name: '2차 전도여행', start: 49.5, end: 52.0, type: 'journey', route: '수리아, 길리기아, 갈라디아, 드로아, 빌립보, 데살로니가, 베뢰아, 아덴, 고린도, 에베소', event: '마게도냐 환상 이후 유럽 선교가 시작되고 고린도에 장기 체류한다.', row: 1 },
  ...
  { name: '3차 전도여행', start: 53.0, end: 57.0, type: 'journey', route: '갈라디아, 브루기아, 에베소, 마게도냐, 헬라, 드로아, 밀레도', event: '에베소를 중심으로 아시아 사역이 확장되고 여러 교회 헌금이 준비된다.', row: 2 },
  ...
  { name: '가이사랴 구금', start: 57.6, end: 59.8, type: 'journey', route: '가이사랴, 벨릭스와 베스도 총독 심문, 아그립바 2세 앞 변론', event: '바울이 로마 시민권에 따라 가이사에게 상소하기 전까지 구금된다.', row: 3 },
  { name: '로마행 항해와 난파', start: 59.8, end: 60.2, type: 'journey', route: '가이사랴, 시돈, 그레데, 멜리데, 수라구사, 보디올, 로마', event: '유라굴로 광풍과 멜리데 난파를 거쳐 로마로 향한다.', row: 4 },
  { name: '로마 1차 연금', start: 60.2, end: 62.2, type: 'journey', route: '로마 셋집', event: '바울이 로마에서 비교적 자유롭게 하나님 나라와 예수 그리스도를 전한다.', row: 0 },
  { name: '바울 석방 후 사역 추정', start: 62.5, end: 66.0, type: 'journey', route: '그레데, 마게도냐, 에베소, 니고볼리, 스페인 가능성 논의', event: '목회서신 배경으로 추정되는 후기 사역. 세부 경로는 전승과 학계 논의가 갈린다.', row: 1 }
];
